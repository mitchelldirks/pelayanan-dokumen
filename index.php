...
<head>
    ...
    <title>Pelayanan Dokumen Online RW 024</title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/GBJ.png" width="150" height="54" alt="logo"></a>
                </div>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> DOKUMEN ONLINE <br>GRIYA BUKIT JAYA RW 024 </h2>
                <p class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">KLIK LOGIN UNTUK REQUEST PEMBUATAN SURAT KETERANGAN/SURAT PENGANTAR
                ...
                <img class="img-responsive wow fadeIn" src="main/images/cta2/bg.png" alt="" data-wow-duration="300ms" data-wow-delay="300ms">
            </div>
        </div>
    </section>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Setelah input data pemohon dengan lengkap dan benar, Pemohon memilih Surat yang mau direquest serta melengkapi data request, Kemudian Dikirim dan Menunggu persetujuan dari Ketua RW.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh Ketua RT dan Ketua RW, kemudian Ketua RT akan mencetak surat sesuai request surat yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan Ketua RT dan Ketua RW.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> Griya Bukit Jaya Gunung Putri Kab. Bogor
                </div>
