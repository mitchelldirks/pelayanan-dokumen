            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form method="POST" class="pt-3">
                <div class="form-group">
                  <label>NIK</label>
                  <input type="number" name="nik" class="form-control form-control-lg" placeholder="NIK Anda.." oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "16" required autofocus autocomplete=’off’>
                </div>
                <div class="form-group">
                  <label>Nama Lengkap</label>
                  <input type="text" name="nama" class="form-control form-control-lg" placeholder="Nama Lengkap Anda.." required autocomplete=’off’>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="kota" class="form-control form-control-lg" placeholder="Kota Lahir Anda.." required autocomplete=’off’>
                </div>
                <div class="form-group">
