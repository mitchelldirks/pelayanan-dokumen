...
<div class="page-inner">
					<div class="row">
						<div class="col-md-12">	
						<form action="post_request.php?module=request_skck&act=tambah" method="POST" enctype="multipart/form-data">
							<div class="card">
										...
										<div class="col-md-6 col-lg-6">
											...
											<div class="col-md-6 col-lg-6">		
												...
												<div class="form-group">
													...
													<input type="file" name="pf" class="form-control" required>
												</div>
											</div>
										</div>
									</div>
