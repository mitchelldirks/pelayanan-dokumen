						...
						<form method="POST">
							<div class="card">
								...
								<div class="card-action">
									...
									<a href="?halaman=tampil_user02" class="btn btn-default btn-sm">Batal</a>
								</div>
							</div>
						</div>
						</form>
...
if(isset($_POST['ubah'])){
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=ubah_user02">';
	  }
}
?> -->
...
<?php
	if(isset($_GET['username'])){
		...
		$tampil_warga02 = "SELECT * FROM data_user WHERE warga=$warga02"
						...
						<form method="POST">
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
											<div class="col-md-6 col-lg-6">
												...
												<div class="form-group">
													<label>Warga RT</label>
													<select name="warga" class="form-control">
														<option disabled="" selected="">Pilih Warga RT</option>
														<option value="Warga RT 01" <?php if($warga01=="Warga RT 01") echo 'radio'?>>Warga RT 01</option>
														<option value="Warga RT 02" <?php if($warga02=="Warga RT 02") echo 'radio'?>>Warga RT 02</option>
													</select>
												</div>
											</div>
									</div>
								...
								<div class="card-action">
									...
									<a href="?halaman=tampil_user02" class="btn btn-default">Batal</a>
								</div>
