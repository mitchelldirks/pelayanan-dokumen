...
<?php
	if(isset($_GET['id_request_skck'])){
		...
		$sql = "SELECT * FROM data_request_skck natural join data_user WHERE id_request_skck='$id_request_skck'";
...
<?php
	if(isset($_POST['ubah'])){
		...
		if($query==1){
			$keterangan = $_POST['keterangan'];
			$ubah = "UPDATE data_request_skck SET
		keterangan='$keterangan' WHERE id_request_skck='$id_request_skck'";
