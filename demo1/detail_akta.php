						...
						<div class="row">
							<div class="col-md-7">
								<div class="card">
									<div class="card-header">
												...
												<a href="?halaman=sudah_acc_akta" class="btn btn-info btn-border btn-round btn-sm">
													Batal
												</a>
												</div>
									</div>
							...
							<div class="col-md-5">
								<div class="card">
									...
									<div class="card-body">
										<div class="row justify-content-md-center">
														<img src="../dataFoto/scan_ktp/<?php echo $ktp1;?>" width="300" height="300" alt="">
										</div>
									</div>
								</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="row justify-content-md-center">
														<img src="../dataFoto/scan_ktp/<?php echo $ktp2;?>" width="300" height="300" alt="">
										</div>
									</div>
								</div>
                                <div class="card">
                                ...
                                <div class="card">
									<div class="card-header">
										<h4 class="card-title">Scan Surat Kelahiran</h4>
									</div>
									<div class="card-body">
										<div class="row justify-content-md-center">
										<img src="../dataFoto/scan_surat_kelahiran/<?php echo $sk;?>" width="350" height="250" alt="">
										</div>
									</div>
								</div>
