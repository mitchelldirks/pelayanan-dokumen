					...
					<form action="" method="POST" enctype="multipart/form-data">
						<div class="row">
							...
							<div class="col-md-5">
                                ...
                                <div class="card">
									<div class="card-header">
										<h4 class="card-title">Scan SKCK</h4>
									</div>
									<div class="card-body">
										<div class="row justify-content-md-center">
										<img src="../dataFoto/skck/<?php echo $skck;?>" width="350" height="250" alt="">
										</div>
									</div>
								</div>
								 <div class="card">
									...
									<div class="card-body">
										<div class="row justify-content-md-center">
										<img src="../dataFoto/pas_foto/<?php echo $pf;?>" width="350" height="250" alt="">
										</div>
									</div>
								</div>
