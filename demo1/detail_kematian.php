...
<?php
	if(isset($_GET['id_request_kematian'])){
		$id_request_kematian=$_GET['id_request_kematian'];
		$sql = "SELECT * FROM data_request_kematian natural join data_user WHERE id_request_kematian='$id_request_kematian'";
							...
							<div class="col-md-7">
								<div class="card">
									<div class="card-header">
												...
												<a href="?halaman=sudah_acc_kematian" class="btn btn-info btn-border btn-round btn-sm">
													Batal
												</a>
												</div>
									</div>
									<div class="card-body">
										...
										<div class="col-md-6 col-lg-6">
													...
													<div class="form-group">
														<label>Nama</label>
														<input type="text" name="nama" value="<?php echo $nama;?>" class="form-control" placeholder="Nama Anda..">
													</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="row justify-content-md-center">
														<img src="../dataFoto/scan_ktp/<?php echo $ktp;?>" width="300" height="300" alt="">
										</div>
									</div>
								</div>
								<div class="card">
									...
									<div class="card-body">
										<div class="row justify-content-md-center">
										<img src="../dataFoto/scan_ktp/<?php echo $ktp1;?>" width="350" height="250" alt="">
										</div>
									</div>
								</div>
                                <div class="card">
									...
									<div class="card-body">
										<div class="row justify-content-md-center">
										<img src="../dataFoto/scan_ktp/<?php echo $ktp2;?>" width="350" height="250" alt="">
										</div>
									</div>
								</div>
...
<?php
	if(isset($_POST['ubah'])){
		...
		if($query==1){
			$keterangan = $_POST['keterangan'];
			$ubah = "UPDATE data_request_kematian SET
		keterangan='$keterangan' WHERE id_request_kematian='$id_request_kematian'";
		...
		if($quey==1){
			...
			echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_kematian">';
		  }
	}
?>
