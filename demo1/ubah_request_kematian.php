...
if(isset($_GET['id_request_kematian'])){
	...
	$tampil_username = "SELECT * FROM data_request_kematian NATURAL JOIN data_user WHERE id_request_kematian=$id";
						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">UBAH DATA REQUEST SURAT KETERANGAN KEMATIAN</div>
								</div>
								<div class="card-body">
									<div class="row">
...
if(isset($_POST['ubah'])){
	...
	$sql = "UPDATE data_request_kematian SET 
	scan_ktp='$file_ktp',
	scan_kk='$file_kk',
	scan_ktp1='$file_ktp1',
	scan_ktp2='$file_ktp2', 
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=id_request_kematian">';
	  }
}
