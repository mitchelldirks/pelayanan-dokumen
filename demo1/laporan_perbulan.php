...
<?php
	...
	FROM
		data_user
	INNER JOIN data_request_kk ON data_request_kk.username = data_user.username
	WHERE month(data_request_kk.acc) = '$bulan'
	UNION
	SELECT
	data_user.username,
		data_user.nik,
	...
	FROM
		data_user
	INNER JOIN data_request_skck ON data_request_skck.username = data_user.username
	WHERE month(data_request_skck.acc) = '$bulan'
    UNION
	SELECT
	data_user.username,
		data_user.nik,
	...
	FROM
		data_user
	INNER JOIN data_request_pernikahan ON data_request_pernikahan.username = data_user.username
	WHERE month(data_request_pernikahan.acc) = '$bulan'
    UNION
	SELECT
	data_user.username,
		data_user.nik,
	...
	FROM
		data_user
	INNER JOIN data_request_kematian ON data_request_kematian.username = data_user.username
	WHERE month(data_request_kematian.acc) = '$bulan'
	";
	$query = mysqli_query($konek,$sql);
	}
