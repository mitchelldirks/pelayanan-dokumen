<table id="add1" class="display table table-striped table-hover" >
                                                ...
                                                if ($_SESSION['hak_akses']=='rt') {
                                                    ...
                                                    $sql = "SELECT * FROM data_request_pernikahan where ".implode(" and ", $where);
													...
													<tr>
														...
														<center>
															...
															<a class="btn btn-success btn-sm" href="approval_aksi.php?halaman=approval&page=pernikahan&id=<?php echo $data['id_request_pernikahan'] ?>&status=approve">Approve</a>
															<a class="btn btn-danger btn-sm" href="approval_aksi.php?halaman=approval&page=pernikahan&id=<?php echo $data['id_request_pernikahan'] ?>&status=decline">Decline</a>
														</center>
													</td>
													</tr>
													<?php
