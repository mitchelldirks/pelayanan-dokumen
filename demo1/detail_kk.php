...
<?php
	if(isset($_GET['id_request_kk'])){
		...
		$sql = "SELECT * FROM data_request_kk natural join data_user WHERE id_request_kk='$id_request_kk'";
					...
					<form action="" method="POST" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-7">
								<div class="card">
									<div class="card-header">
												...
												<a href="?halaman=sudah_acc_kk" class="btn btn-info btn-border btn-round btn-sm">
													Batal
												</a>
												</div>
									</div>
							...
							<div class="col-md-5">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Scan Surat Nikah</h4>
									</div>
									<div class="card-body">
...
<?php
	if(isset($_POST['ubah'])){
		...
		if($query==1){
			$keterangan = $_POST['keterangan'];
			$ubah = "UPDATE data_request_kk SET
		keterangan='$keterangan' WHERE id_request_kk='$id_request_kk'";
		...
		if($quey==1){
			...
			echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_kk">';
		  }
	}
?>