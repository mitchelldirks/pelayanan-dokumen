						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">FORM TAMBAH REQUEST SURAT PENGANTAR KTP</div>
								</div>
								<div class="card-body">
									<div class="row">
...
if(isset($_POST['kirim'])){
	...
	$sql = "INSERT INTO data_request_ktp (username,scan_ktp,scan_kk,akta_lahir,keperluan) VALUES ('$username','$file_ktp','$file_kk','$file_akta','$keperluan')";
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=request_ktp">';
	  }
}
