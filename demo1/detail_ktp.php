						...
						<div class="row">
								...
								<div class="card">
									<div class="card-header">
										...
										<label>Keterangan</label>
											...
											<a href="?halaman=sudah_acc_ktp" class="btn btn-info btn-border btn-round btn-sm">
												Batal
											</a>
											</div>
									</div>
									<div class="card-body">
										...
										<div class="col-md-6 col-lg-6">
													...
													<div class="form-group">
														<label>NIK</label>
														<input type="number" name="nik" value="<?php echo $nik;?>" class="form-control" placeholder="NIK Anda..">
													</div>
													<div class="form-group">
														<label>Nama</label>
							...
							<div class="col-md-5">
								<div class="card">
									...
									<div class="card-header">
										<h4 class="card-title">Scan Akta Lahir</h4>
									</div>
									<div class="card-body">
										<div class="row justify-content-md-center">
										<img src="../dataFoto/akta_lahir/<?php echo $akta;?>" width="300" height="300" alt="">
										</div>
									</div>
...
<?php
	if(isset($_POST['ubah'])){
		...
		if($query==1){
			...
			$ubah = "UPDATE data_request_ktp SET
		keterangan='$keterangan' WHERE id_request_ktp='$id_request_ktp'";
		...
		if($quey==1){
			...
			echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_ktp">';
		  }
	}
?>